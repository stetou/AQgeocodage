...
class AQGeocodage:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Adresse Quebec Geocodage')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'AQGeocodage')
        self.toolbar.setObjectName(u'AQGeocodage')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('AQGeocodage', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/AQGeocodage/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Localiser une adresse'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Adresse Quebec Geocodage'),
                action)
